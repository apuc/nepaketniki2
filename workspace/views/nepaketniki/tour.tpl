...
<div class="-single-tour-info">
    ...
    <div class="-single-tour-info__text">
        ...
        <div class="-single-tour-info__weather"><strong>Сложность поездки и
                погода: </strong><span>{$model->difficulties_and_weather}</span></div>
        <div class="-single-tour-info__places"><span>Количество мест: {$model->amount_of_places}</span></div>
    </div>
</div>
...
<div class="comments" id="comments">
    ...
    <div class="comments__pagination">
        <button class="comments__button" id="prevPage"></button>
        <span class="comments__current-page"><span id='currentPage'></span> из <span id='pages'></span></span>
