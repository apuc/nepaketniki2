...
class TourController extends Controller
{
    ...
    public function actionView($id)
    {
        ...
        return $this->render('tour/view.tpl', ['model' => $model, 'options' => $this->getOptions(),  'plans' => $plans, 'plans_options' => $plans_options, 'features' => $features, 'features_options' => $features_options,
    ...
    {
        AdditionalPrice::where('tour_id',$_POST['id'])->delete();
        Date::where('tour_id',$_POST['id'])->delete();
        Feature::where('tour_id',$_POST['id'])->delete();
        Included::where('tour_id',$_POST['id'])->delete();
