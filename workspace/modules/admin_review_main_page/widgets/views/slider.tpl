<div class="comments" id="comments">
    ...
    <div class="comments__pagination">
        <button class="comments__button" id="commentsPrevPage"></button>
        <span class="comments__current-page"><span id="commentsCurrentPage"></span> из <span id="commentsPages"></span></span>
