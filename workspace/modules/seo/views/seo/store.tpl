{core\App::$breadcrumbs->addItem(['text' => 'Создание meta-тегов'])}
<div class="h1">{$h1}</div>

<div class="container mt-5">
    <form class="form-horizontal" name="create_form" id="create_form" method="post" action="/admin/seo/create">
        <div class="form-group">
            <label for="date">Страница:</label>
            <input type="text" name="page" id="title" class="form-control"/>
